# Lab 3 - Advanced Portfolio with Flexbox & Grid
...
The website has been tested across different device breakpoints:

1.  **Desktop (> 768px)**:
    - Navigation links are visible.
    - Hero section displays text on the left and image on the right.
    - Skills grid displays 4 columns.
    - Projects grid adapts to available width.

2.  **Tablet/Mobile (< 768px)**:
    - Hero section stacks vertically (image below text).
    - Skills grid adjusts to 2 columns or 1 column depending on width.
    - Navigation adjusts spacing.

3.  **Small Mobile (< 480px)**:
    - Skills grid becomes a single column.
    - Layout is fully fluid.

## How to View
1.  Open `index.html` in any modern web browser (Chrome, Edge, Firefox).
2.  Resize the browser window to see the layout adapt to different widths.
